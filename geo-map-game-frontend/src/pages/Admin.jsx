...
export default function Admin() {
  ...
  const fetchPage = async (page) => {
    ...
    try {
      const res = await api.get(`/locations?page=${page}&limit=${limit}`);
  ...
  const handlePageChange = (ofPage = "locations", page) => {
    ...
    if (page === loadedPages[ofPage] && page < totalPages[ofPage]) {
      ofPage == "locations" ? fetchPage(page + 1) : fetchGroupsPage(page + 1);
    }
  };
      ...
      >
        ...
        <div className="flex flex-wrap justify-center mt-6 gap-2">
          <button
            ...
            onClick={() =>
              handlePageChange("locations", currentPage["locations"] - 1)
            }
      ...
      >
        ...
        <div className="flex flex-wrap justify-center mt-6 gap-2">
          <button
            ...
            onClick={() =>
              handlePageChange("groups", currentPage["groups"] - 1)
            }
            className="px-3 py-1 rounded-lg bg-gray-200 dark:bg-slate-700 disabled:opacity-50"
          >
            ◀
