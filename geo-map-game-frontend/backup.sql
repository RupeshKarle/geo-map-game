...
--
-- Name: public; Type: SCHEMA; Schema: -; Owner: geo
--

-- *not* creating schema, since initdb creates it
GRANT geo TO neondb_owner; 

-- 3. Now the existing line in your backup will work:
SET ROLE "geo";
ALTER SCHEMA public OWNER TO geo;

-- 2. Ensure 'geo' has all permissions on it
GRANT ALL ON SCHEMA public TO geo;
...
--
-- Name: attempts; Type: TABLE; Schema: public; Owner: geo
--
...
ALTER TABLE public.attempts OWNER TO geo;

--
-- Name: attempts_id_seq; Type: SEQUENCE; Schema: public; Owner: geo
--
...
ALTER SEQUENCE public.attempts_id_seq OWNER TO geo;

--
-- Name: attempts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: geo
--
...
--
-- Name: game_sessions; Type: TABLE; Schema: public; Owner: geo
--
...
ALTER TABLE public.game_sessions OWNER TO geo;

--
-- Name: game_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: geo
--
...
ALTER SEQUENCE public.game_sessions_id_seq OWNER TO geo;

--
-- Name: game_sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: geo
--
...
--
-- Name: locations; Type: TABLE; Schema: public; Owner: geo
--
...
ALTER TABLE public.locations OWNER TO geo;

--
-- Name: locations_id_seq; Type: SEQUENCE; Schema: public; Owner: geo
--
...
ALTER SEQUENCE public.locations_id_seq OWNER TO geo;

--
-- Name: locations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: geo
--
...
--
-- Name: attempts id; Type: DEFAULT; Schema: public; Owner: geo
--
...
--
-- Name: game_sessions id; Type: DEFAULT; Schema: public; Owner: geo
--
...
--
-- Name: locations id; Type: DEFAULT; Schema: public; Owner: geo
--
...
--
-- Data for Name: attempts; Type: TABLE DATA; Schema: public; Owner: geo
--
...
--
-- Data for Name: game_sessions; Type: TABLE DATA; Schema: public; Owner: geo
--
...
--
-- Data for Name: locations; Type: TABLE DATA; Schema: public; Owner: geo
--
...
--
-- Name: attempts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: geo
--
...
--
-- Name: game_sessions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: geo
--
...
--
-- Name: locations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: geo
--
...
--
-- Name: attempts attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: geo
--
...
--
-- Name: game_sessions game_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: geo
--
...
--
-- Name: locations locations_pkey; Type: CONSTRAINT; Schema: public; Owner: geo
--
...
--
-- Name: idx_refresh_user_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: attempts attempts_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: geo
--
...
--
-- Name: game_sessions game_sessions_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: geo
--
...
--
-- Name: game_sessions game_sessions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: geo
--
...
--
-- Name: locations locations_found_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: geo
--
...
GRANT ALL ON TABLE public.refresh_tokens TO geo;
...
GRANT ALL ON SEQUENCE public.refresh_tokens_id_seq TO geo;
...
GRANT ALL ON TABLE public.users TO geo;
...
GRANT ALL ON SEQUENCE public.users_id_seq TO geo;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT ALL ON SEQUENCES TO geo;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT ALL ON TABLES TO geo;
